...
void write_result_to_file(int taskid, DebugParam_t *debug) {
		enum BASEADDR {
			...
			RES_C1_DATA = 125411328,
			RES_C2_DATA = 131383296,
			RES_C3_DATA = 137355264,
			RES_C4_DATA = 143327232,
			RES_D4_DST_DATA = 149299200,
			RES_D3_1_DATA = 173187074,
			RES_D3_2_DATA = 179159042,
			RES_D3_3_DATA = 185131010,
			RES_D3_2_DST_DATA = 191102978,
			RES_D3_3_DST_DATA = 194088962
