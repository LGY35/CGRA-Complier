...
void decoder(string decode_dir, bool (&Pea_enable)[PE_SIZE], char *debugtrace, DebugParam_t *debug, int taskid)
{
    ...
    if (!in)
    {
        cout << "Error: failed to open machine code file" << endl;
    }
    assert(in);
    ...
    while (getline(in, line))
    {
        ...
        case (1):
        {
            ...
            {
                os << " IF(INX<INY) ";
                PECSPM_TEMP_NEW.PE_CSPM.PE_IF.mode = 0;
                break;
            }
            case (1):
            {
                os << " IF(INX<=INY) ";
                PECSPM_TEMP_NEW.PE_CSPM.PE_IF.mode = 1;
                break;
            }
            case (2):
            {
                os << " IF(INX==INY) ";
                PECSPM_TEMP_NEW.PE_CSPM.PE_IF.mode = 2;
                break;
            }
            case (3):
            {
                os << " IF(INX==1) ";
                PECSPM_TEMP_NEW.PE_CSPM.PE_IF.mode = 3;
                break;
            }
            }
            ...
            {
                os << " RESULT(1/0)";
                PECSPM_TEMP_NEW.PE_CSPM.PE_IF.result = 0;
                break;
            }
            case (1):
            {
                os << " RESULT(INX/INY)";
                PECSPM_TEMP_NEW.PE_CSPM.PE_IF.result = 1;
                break;
            }
            case (2):
            {
                os << " RESULT(INY/INZ)";
                PECSPM_TEMP_NEW.PE_CSPM.PE_IF.result = 2;
                break;
            }
            case (3):
            {
                os << " RESULT(INX/INZ)";
                PECSPM_TEMP_NEW.PE_CSPM.PE_IF.result = 3;
                break;
            }
            }
            ...
            {
                os << "|(T/F) ";
                PECSPM_TEMP_NEW.PE_CSPM.PE_IF.if_pattern = 0;
            }
            else
            {
                os << "|(F/T) ";
                PECSPM_TEMP_NEW.PE_CSPM.PE_IF.if_pattern = 1;
            }
            break;
        }
        case (2):
        ...
        case (3):
        {
            ...
            case (0):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_ARITH.mode = 0;
                os << " SADD ";
                break;
            }
            case (1):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_ARITH.mode = 1;
                os << " SSUB ";
                break;
            }
            case (2):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_ARITH.mode = 2;
                os << " SABS ";
                break;
            }
            case (3):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_ARITH.mode = 3;
                os << " NEG ";
                break;
            }
            case (4):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_ARITH.mode = 4;
                os << " SMUL ";
                break;
            }
            case (5):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_ARITH.mode = 5;
                os << " SMAC ";
                break;
            }
            case (6):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_ARITH.mode = 6;
                os << " SMOD ";
                break;
            }
            case (7):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_ARITH.mode = 7;
                os << " SDIV ";
                break;
            }
            default:
        ...
        { // logic
            ...
            case (0):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_LOGIC.mode = 0;
                os << " AND ";
                break;
            }
            case (1):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_LOGIC.mode = 1;
                os << " OR ";
                break;
            }
            case (2):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_LOGIC.mode = 2;
                os << " NOT ";
                break;
            }
            case (3):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_LOGIC.mode = 3;
                os << " XOR ";
                break;
            }
            default:
        ...
        { // shifter
            ...
            case (0):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_SHIFTER.mode = 0;
                os << " SRL ";
                break;
            }
            case (1):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_SHIFTER.mode = 1;
                os << " SRA ";
                break;
            }
            case (2):
            {
                PECSPM_TEMP_NEW.PE_CSPM.PE_SHIFTER.mode = 2;
                os << " SL(A/L) ";
                break;
            }
            default:
