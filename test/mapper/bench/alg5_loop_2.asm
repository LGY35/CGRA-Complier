...
/*generating asm for node name "rout30"*/
//iteration_cycle=11943936|start_cycle=5|II=3|out=14/*gr[1]*/
%rout gr[4]
/*generating asm for node name "rout36"*/
//iteration_cycle=11943936|start_cycle=9|II=3|out=14/*gr[1]*/
%rout gr[1]

PE[1]
%TOP CP_index_=x|CP_num=x|Instruction_num=3
/*generating asm for node name "loop_add59"*/
...
PE[5]
%TOP CP_index_=x|CP_num=x|Instruction_num=4
/*generating asm for node name "and8"*/
//iteration_cycle=1|start_cycle=0|II=0|out=11
%imm 1,imm_reg[0]
//iteration_cycle=11943936|start_cycle=7|II=3|out=5/*pe_right*/
%and gr[1],imm_reg[0]
...
%if a==1,pe_left,pe_right,imm_reg[1]

PE[6]
%TOP CP_index_=x|CP_num=x|Instruction_num=4
/*generating asm for node name "eq13"*/
//iteration_cycle=1|start_cycle=0|II=0|out=11
%imm 0,imm_reg[0]
//iteration_cycle=11943936|start_cycle=8|II=3|out=7/*pe_left*/
%if a==b,pe_left,imm_reg[0]
...
//iteration_cycle=1|start_cycle=0|II=0|out=11
%imm 6,imm_reg[0]
//iteration_cycle=11943936|start_cycle=7|II=3|out=6/*pe_down*/
%smul gr[1],imm_reg[0]
/*generating asm for node name "add43"*/
//iteration_cycle=1|start_cycle=0|II=0|out=12
%imm %1,imm_reg[1]
//iteration_cycle=11943936|start_cycle=9|II=3|out=7/*pe_left*/
%sadd imm_reg[1],pe_down
/*generating asm for node name "store6"*/
...
PE[11]
%TOP CP_index_=x|CP_num=x|Instruction_num=1
/*generating asm for node name "and6"*/
...
/*generating asm for node name "loop_add58"*/
//iteration_cycle=1|start_cycle=0|II=0|out=12
%imm 0,imm_reg[1]
//iteration_cycle=1|start_cycle=5|II=0|out=5/*pe_right*/|out=15/*gr[2]*/|out=0/*lr[0]*/
%rout imm_reg[1]
//iteration_cycle=11943935|start_cycle=8|II=3|out=5/*pe_right*/|out=15/*gr[2]*/|out=0/*lr[0]*/
%sadd lr[0],pe_left

PE[13]
%TOP CP_index_=x|CP_num=x|Instruction_num=5
/*generating asm for node name "shr6"*/
//iteration_cycle=1|start_cycle=0|II=0|out=11
%imm 1,imm_reg[0]
...
PE[14]
%TOP CP_index_=x|CP_num=x|Instruction_num=4
/*generating asm for node name "add41"*/
//iteration_cycle=11943936|start_cycle=9|II=3|out=5/*pe_right*/
...
//iteration_cycle=11943936|start_cycle=8|II=3|out=8/*pe_up*/|out=3/*gr[0]*/
%sadd pe_left,pe_up
/*generating asm for node name "shr7"*/
//iteration_cycle=1|start_cycle=0|II=0|out=11
%imm 1,imm_reg[0]
...
/*generating asm for node name "add50"*/
//iteration_cycle=1|start_cycle=0|II=0|out=12
%imm 2,imm_reg[1]
//iteration_cycle=11943936|start_cycle=10|II=3|out=5/*pe_right*/
%sadd gr[0],imm_reg[1]
...
//iteration_cycle=1|start_cycle=0|II=0|out=11
%imm 4608,imm_reg[0]
//iteration_cycle=11943936|start_cycle=7|II=3|out=5/*pe_right*/|out=7/*pe_left*/|out=6/*pe_down*/|out=14/*gr[1]*/
%smul pe_up,imm_reg[0]
/*generating asm for node name "add47"*/
//iteration_cycle=11943936|start_cycle=9|II=3|out=5/*pe_right*/
%sadd pe_down,pe_up
/*generating asm for node name "add51"*/
//iteration_cycle=1|start_cycle=0|II=0|out=12
%imm %1,imm_reg[1]
//iteration_cycle=11943936|start_cycle=11|II=3|out=5/*pe_right*/
...
PE[23]
%TOP CP_index_=x|CP_num=x|Instruction_num=1
/*generating asm for node name "store7"*/
//iteration_cycle=11943936|start_cycle=13|II=3
%store pe_up,pe_left

PE[27]
%TOP CP_index_=x|CP_num=x|Instruction_num=1
/*generating asm for node name "rout42"*/
//iteration_cycle=11943936|start_cycle=10|II=3|out=5/*pe_right*/
%rout gr[0]
...
/*generating asm for node name "add56"*/
//iteration_cycle=1|start_cycle=0|II=0|out=12
%imm %1,imm_reg[1]
//iteration_cycle=11943936|start_cycle=12|II=3|out=5/*pe_right*/
%sadd imm_reg[1],pe_left
...
PE[30]
%TOP CP_index_=x|CP_num=x|Instruction_num=4
/*generating asm for node name "add52"*/
//iteration_cycle=1|start_cycle=0|II=0|out=11
%imm %6,imm_reg[0]
...
PE[31]
%TOP CP_index_=x|CP_num=x|Instruction_num=2
/*generating asm for node name "store8"*/
//iteration_cycle=11943936|start_cycle=14|II=3
%store pe_down,pe_left
/*generating asm for node name "rout34"*/
//iteration_cycle=11943936|start_cycle=12|II=3|out=7/*pe_left*/
%rout gr[0]

PE[38]
%TOP CP_index_=x|CP_num=x|Instruction_num=1
/*generating asm for node name "add53"*/
//iteration_cycle=11943936|start_cycle=12|II=3|out=5/*pe_right*/
%sadd pe_up,gr[3]
